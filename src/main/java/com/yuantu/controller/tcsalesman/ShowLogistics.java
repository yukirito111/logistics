...
@Controller
@RequestMapping(value = "/ShowLogistics", method = {RequestMethod.POST})
public class ShowLogistics {
    ...
    @ResponseBody //添加物流单
    @RequestMapping(value = "/inseertLogistics", method = {RequestMethod.POST})
    ...
    @ResponseBody //设置物流编号
    @RequestMapping(value = "/updateLogisticsNum", method = {RequestMethod.POST})
    ...
    @RequestMapping(value = "/selectLogisticsByNum", method = {RequestMethod.POST})
